...
- Programming
  * *v0.4.0* Sequential "base"
    ...
    ** libraries - base without number
    ** tools - scm shell

  * *v0.5.0* Sequential "numbers"
    ** libraries - base number, complex, inexact

  * *v0.6.0* Sequential "libraries"
    ** programs - import, define-library
    ** libraries - case-lambda, char, cxr, eval, file, lazy, load,
       process-context, read, repl, jiffy, write, r5rs
